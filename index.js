...
var mongoDB = "mongodb+srv://nithin_rajan:X6pHM7DCxmr5JJOJ@cluster0.arzd1.mongodb.net/book-company?retryWrites=true&w=majority";
mongoose.connect(mongoDB, {useNewUrlParser: true, useUnifiedTopology: true}).then(()=>console.log("CONNECTION ESTABLISHED"));


const { MongoClient } = require('mongodb');
const uri ="mongodb+srv://nithin_rajan:X6pHM7DCxmr5JJOJ@cluster0.arzd1.mongodb.net/book-company?retryWrites=true&w=majority" ;
